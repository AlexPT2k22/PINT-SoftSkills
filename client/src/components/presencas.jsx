            ...
            <tbody>
              {presencas.map(presenca => (
                <tr key={presenca.ID_PRESENCA}>
                  <td>{presenca.Utilizador?.NOME || presenca.Utilizador?.USERNAME}</td>
                  <td>{presenca.Utilizador?.EMAIL}</td>
                  <td>
                  ...
                  <td>
                    <div className="btn-group" role="group">
                      <button
                        type="button"
                        className={`btn btn-sm ${presenca.PRESENTE ? 'btn-success' : 'btn-outline-success'}`}
                        onClick={() => handleMarcarPresenca(presenca.Utilizador.ID_UTILIZADOR, true)}
                      ...
                      <button
                        type="button"
                        className={`btn btn-sm ${!presenca.PRESENTE ? 'btn-danger' : 'btn-outline-danger'}`}
                        onClick={() => handleMarcarPresenca(presenca.Utilizador.ID_UTILIZADOR, false)}
